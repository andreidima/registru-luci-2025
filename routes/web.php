...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('/registru/import', [RegistruImportController::class, 'showImportForm'])->name('registru.import.form');
    Route::post('/registru/import', [RegistruImportController::class, 'import'])->name('registru.import');
    Route::get('/registru/export/{tip}/{sector}/{view_type}', [RegistruController::class, 'pdfExportRegistre'])->name('registru.export');
